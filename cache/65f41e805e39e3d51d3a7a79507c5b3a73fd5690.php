    ...
    <div class="container">
        <div class="media-container-row">
            <div class="mbr-text counter-container col-12 col-md-8 mbr-fonts-style display-7">
                <ol>
                    <li><strong>DYNAMIQUE</strong> - Que ce soit sur mobile ou ordinateur, vous pouvez accéder à la totalité des fonctions qu'offre <?php echo e(config('name')); ?>. Vous n'avez plus d'excuse pour réserver vos prochains trajets.</li>
                    ...
                    <li><strong>COMMUNAUTAIRE</strong>&nbsp;- Parce que le covoiturage ne serait rien sans vous, <?php echo e(config('name')); ?> s'engage à vous fournir une utilisation aussi simple que possible et à améliorer continuellement les services qui vous sont proposés.</li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="media-container-row">
            <div class="media-block" style="width: 50%;">
                <h2 class="mbr-section-title pb-3 align-left mbr-fonts-style display-2">
                    <?php echo e(strtoupper(config('name'))); ?>
                ...
                <div class="mbr-figure">
                    <img src="<?php echo e(asset('resources/images/about.jpg')); ?>">
                </div>
            </div>
                    ...
                    <div class="card px-3 align-left col-12 col-md-6">
                        <div class="panel-item p-3">
                            ...
                            <div class="card-text">
                                ...
                                <p class="mbr-content-text mbr-fonts-style display-7">
                                    Le nombre de personne derrière <?php echo e(config('name')); ?>
...
<section class="features16 cid-qLTL4NMPHQ" id="features16-k">
    <div class="container align-center">
        ...
        <h3 class="pb-5 mbr-section-subtitle mbr-fonts-style mbr-light display-5">
            Celles et ceux qui sont derrières <?php echo e(config('name')); ?>.
        </h3>
        <div class="row media-row">
            <?php $__currentLoopData = $teams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="team-item col-lg-3 col-md-6">
                <div class="item-image">
                    <img src="<?php echo e(asset('resources/images/team/' . $member->id . '.jpg')); ?>">
                </div>
