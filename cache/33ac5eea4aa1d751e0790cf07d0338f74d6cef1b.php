<?php $__env->startSection('title', 'Voyagez en toute confiance'); ?>
    ...
    <div class="container">
        <div class="inner-container" style="width: 100%;">
            ...
            <div class="section-text align-center mbr-fonts-style display-5">
                <?php echo e(config('name')); ?> compte des milliers de membres. Nous avons vérifié leurs profils, un par un.
            </div>
            <hr class="line" style="width: 25%;">
        </div>
    </div>
            ...
            <div class="col-12 col-md-8">
                <div class="media-container-row">
                    <div class="mbr-figure" style="width: 60%;">
                        <img src="<?php echo e(asset('resources/images/trust/authenticity.png')); ?>">
                    </div>
            ...
            <div class="col-12 col-md-8">
                <div class="media-container-row">
                    ...
                    <div class="mbr-figure" style="width: 70%;">
                        <img style="padding-left: 30px;" src="<?php echo e(asset('resources/images/trust/eval.png')); ?>">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="media-container-row">
            <div class="col-12 col-md-8">
                <div class="media-container-row">
                    <div class="mbr-figure" style="width: 60%;">
                        <img src="<?php echo e(asset('resources/images/trust/freedom.png')); ?>">
                    </div>
                    <div class="media-content">
                        <div class="mbr-section-text">
        ...
        <div class="media-container-row">
            <div class="col-12 col-md-8">
                <div class="media-container-row">
                    ...
                    <div class="mbr-figure" style="width: 70%;">
                        <img style="padding-left: 30px;" src="<?php echo e(asset('resources/images/trust/moderation.png')); ?>">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="media-container-row">
            <div class="col-12 col-md-8">
                <div class="media-container-row">
                    <div class="mbr-figure" style="width: 60%;">
                        <img src="<?php echo e(asset('resources/images/trust/contact.png')); ?>">
                    </div>
                    <div class="media-content">
                        <div class="mbr-section-text">
        ...
        <div class="media-container-row">
            <div class="col-12 col-md-8">
                <div class="media-container-row">
                    ...
                    <div class="mbr-figure" style="width: 70%;">
                        <img style="padding-left: 30px;" src="<?php echo e(asset('resources/images/trust/team.jpg')); ?>">
                    </div>
                </div>
            </div>
        </div>
