                                            ...
                                            <div class="row row-sm-offset">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="autobio" class="form-control" rows="4" placeholder="Que faites-vous dans votre temps libre ? Où allez-vous le plus souvent ? Qu'est-ce qui fait de vous une personne avec qui il est agréable de voyager ?"><?php echo e(user()->autobio); ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
