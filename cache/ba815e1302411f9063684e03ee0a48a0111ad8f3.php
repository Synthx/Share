        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="media-container-column col-lg-10">
                    <form class="mbr-form" action="<?php echo e(route('contact')); ?>" method="post">
                        <?php echo csrf(); ?>
                        ...
                        <div class="row row-sm-offset">
                            ...
                            <div class="col-md-4 multi-horizontal">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="fisrtname" value="<?php echo e(old('firstname')); ?>">
                                </div>
                            </div>
                            <div class="col-md-4 multi-horizontal">
                                <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" class="form-control" name="message" rows="7"><?php echo e(old('message')); ?></textarea>
                        </div>
